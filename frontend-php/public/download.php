        ...
        <div class="invoice-box">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php if ($isInvoice): ?>
                        <tr>
                            <td><strong>Plan Business Max - Suscripción Mensual</strong><br><small>Monitorización SOC 24/7 y
                                    Protección Endpoints</small></td>
                            <td>1</td>
                            <td style="text-align: right;">1.239,67 €</td>
                            <td style="text-align: right;">1.239,67 €</td>
                        </tr>
                        <tr>
                            <td><strong>IR Retainer (Pack 10 horas)</strong><br><small>Respuesta ante incidentes
                                    priorizada</small></td>
                            <td>1</td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td><strong>Auditoría de Perímetro Externo</strong><br><small>Análisis de vulnerabilidades y
                                    exposición</small></td>
                            <td>1</td>
            ...
            <div style="margin-top: 30px; text-align: center;" class="no-print">
                <button onclick="window.print()"
                    style="padding: 10px 24px; border-radius: 8px; background: #8b5cf6; color: white; border: none; font-weight: 700; cursor: pointer;">Imprimir
                    o Guardar como PDF</button>
            </div>
        </div>
        <style>
            @media print {
