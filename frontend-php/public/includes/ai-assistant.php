...
<div class="ai-chat-window" id="ai-window">
    <div class="ai-header">
        ...
        <button onclick="toggleAIChat()"
            style="margin-left:auto; background:none; border:none; color:#64748b; cursor:pointer; font-size:1.2rem;">&times;</button>
    </div>
    <div class="ai-body" id="ai-messages">
        <div class="msg msg-ai">¡Hola! Soy Nova AI, el asistente inteligente de Sofia Solutions. Estoy aquí para
            ayudarte a supervisar y proteger tu infraestructura. ¿En qué te puedo ayudar hoy?</div>

        <div id="ai-suggestions" style="display:flex; flex-wrap:wrap; gap:8px; margin-top:4px;">
            <button class="ai-suggestion-btn" onclick="sendAiSuggestion('¿Qué planes de servicio tienen?')">Planes y
                Precios</button>
            <button class="ai-suggestion-btn" onclick="sendAiSuggestion('¿Cómo funciona el SOC?')">Monitorización
                SOC</button>
            <button class="ai-suggestion-btn" onclick="sendAiSuggestion('Háblame sobre la empresa')">Sobre
                Nosotros</button>
        </div>
    </div>
    <form class="ai-footer" onsubmit="handleAISubmit(event)">
        ...
        <button type="submit"
            style="background:#4f46e5; border:none; border-radius:10px; padding:10px; color:#fff; cursor:pointer;">
