...
<main class="auth-shell">
        ...
        <div class="auth-brand-frame">
            ...
            <div style="display:flex;flex-direction:column;gap:10px;margin-top:38px;">
                <div style="display:flex;align-items:center;gap:10px;">
                    <span
                        style="width:7px;height:7px;border-radius:50%;background:#10b981;box-shadow:0 0 8px #10b981;flex-shrink:0;"></span>
                    <span style="font-size:0.82rem;color:rgba(203,213,225,0.75);">Plataforma operativa &mdash; 100%
                        uptime</span>
                </div>
                <div style="display:flex;align-items:center;gap:10px;">
                    <span
                        style="width:7px;height:7px;border-radius:50%;background:#10b981;box-shadow:0 0 8px #10b981;flex-shrink:0;"></span>
                    <span style="font-size:0.82rem;color:rgba(203,213,225,0.75);">SOC activo 24/7 &mdash; Telemetría en
                        tiempo real</span>
                </div>
            </div>
        </div>
    ...
    <section class="auth-panel auth-panel-form">
        <div class="auth-card"
            style="width:min(460px,100%);padding:40px 36px;border-radius:18px;background:rgba(10,14,24,0.92);border:1px solid rgba(255,255,255,0.09);box-shadow:0 8px 40px rgba(0,0,0,0.5);">
            ...
            <form id="login-form" class="login-form" method="POST" onsubmit="return false;" style="gap:14px;">
                ...
                <?php if (isset($mode) && $mode === 'secure'): ?>
                    <div
                        style="display:flex;align-items:center;gap:12px;padding:12px 14px;border:1px solid rgba(255,255,255,0.1);border-radius:10px;background:rgba(255,255,255,0.03);">
                        <input type="checkbox" id="hcaptcha" name="hcaptcha" required
                            style="width:17px;height:17px;cursor:pointer;flex-shrink:0;">
                        <div style="flex:1;">
                            <label for="hcaptcha"
                                style="margin:0;cursor:pointer;font-weight:600;color:rgba(203,213,225,0.9);font-size:0.86rem;">No
                                soy un robot</label>
                            <small
                                style="display:block;color:rgba(100,116,139,0.9);font-size:0.73rem;margin-top:2px;">Verificación
                                de seguridad requerida</small>
                        </div>
            ...
            <div style="margin-top:20px;display:flex;justify-content:center;">
                <a href="/" style="color:rgba(100,116,139,0.8);font-size:0.83rem;text-decoration:none;"
                    onmouseover="this.style.color='rgba(203,213,225,0.9)'"
                    onmouseout="this.style.color='rgba(100,116,139,0.8)'">&#8592; Volver al inicio</a>
            </div>
        </div>
    </section>
